        ...
        <div className=" col-12 row d-flex justify-content-evenly align-items-center">
          {array.map((ab, ind) => (
            <div className="col-4 m-3">
              <div className="br-15 py-2 px-4 d-flex flex-column align-items-center bg-box1 li-shadow cursor-pointer">
              ...
              <div className="br-15 mt-3 py-2 px-4 d-flex flex-column align-items-center bg-box1 li-shadow cursor-pointer">
                <div className="h3 fw-bold cursor-pointer d-flex align-items-center col-12 justify-content-center">
                  <div className="me-2">{ab}.</div>
                  <TextField
                    id="standard-basic"
